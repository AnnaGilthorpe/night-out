        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          >
            {selections.map((selections,i) => (
              <li key={i} className="bg-amber-100 rounded shadow md p-2">
               ...
               className="rounded-full bg-gray-600 py-2 px-3.5 text-sm uppercase font-semibold text-amber-100 shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
             >
               Book now
             </button>
                  </li>
